...
(*let display acc = print_newline (); print_endline "Account Information";
  print_endline (print_info "Account Username" (username acc)); print_endline
  (print_info "Balance" (balance acc)); print_newline ()
...
let display acc =
  "\n" ^ "Account Information\n"
  ^ print_info "Account Username" (username acc)
  ^ "\n"
  ^ print_info "Balance" (balance acc)
  ^ "\n"
